...
{
    public class InterfaceMonitoringDA : ConnectionBase
    {
        ...
        public Task<InterfaceMonitoringSiniestrosVM> ListarCabeceraInterfacesSiniestros(InterfaceMonitoringSiniestrosFilter data)
        {
            var parameters = new List<OracleParameter>();
            InterfaceMonitoringSiniestrosVM entities = new InterfaceMonitoringSiniestrosVM();
            entities.lista = new List<InterfaceMonitoringSiniestrosVM.P_TABLE>();
            var procedure = string.Format("{0}.{1}", this.Package, "SPS_OI_SEL_PROCESS_CAB_SIN_MEMO");
            try
            {
                parameters.Add(new OracleParameter("P_SCLAIM_MEMO", OracleDbType.NVarchar2, data.CLAIM_MEMO, ParameterDirection.Input));
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        InterfaceMonitoringSiniestrosVM.P_TABLE suggest = new InterfaceMonitoringSiniestrosVM.P_TABLE();
                        suggest.NIDPROCESS = reader["NIDPROCESS"] == DBNull.Value ? 0 : int.Parse(reader["NIDPROCESS"].ToString());
                        suggest.NCODGRU = reader["NCODGRU"] == DBNull.Value ? 0 : int.Parse(reader["NCODGRU"].ToString());
                        suggest.SCODGRU_DES = reader["SCODGRU_DES"] == DBNull.Value ? string.Empty : reader["SCODGRU_DES"].ToString();
                        suggest.NBRANCH = reader["NBRANCH"] == DBNull.Value ? 0 : int.Parse(reader["NBRANCH"].ToString());
            ...
            {
                LogControl.save("ListarCabeceraInterfacesSiniestros", ex.ToString(), "3");
                throw;
            }
            return Task.FromResult<InterfaceMonitoringSiniestrosVM>(entities);
        }
        public Task<InterfaceMonitoringPolizaVM> ListarCabeceraInterfacesPoliza(InterfaceMonitoringPolizaFilter data)
        {
            var parameters = new List<OracleParameter>();
            InterfaceMonitoringPolizaVM entities = new InterfaceMonitoringPolizaVM();
            entities.lista = new List<InterfaceMonitoringPolizaVM.P_TABLE>();
            var procedure = string.Format("{0}.{1}", this.Package, "SPS_OI_SEL_PROCESS_CAB_POL");
            try
            {
                parameters.Add(new OracleParameter("P_NNUMORI", OracleDbType.Int16, data.P_NNUMORI, ParameterDirection.Input));
                parameters.Add(new OracleParameter("P_SPOLICY", OracleDbType.NVarchar2, data.P_SPOLICY, ParameterDirection.Input));
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        InterfaceMonitoringPolizaVM.P_TABLE suggest = new InterfaceMonitoringPolizaVM.P_TABLE();
                        suggest.NIDPROCESS = reader["NIDPROCESS"] == DBNull.Value ? 0 : int.Parse(reader["NIDPROCESS"].ToString());
                        suggest.NCODGRU = reader["NCODGRU"] == DBNull.Value ? 0 : int.Parse(reader["NCODGRU"].ToString());
                        suggest.SCODGRU_DES = reader["SCODGRU_DES"] == DBNull.Value ? string.Empty : reader["SCODGRU_DES"].ToString();
                        suggest.NBRANCH = reader["NBRANCH"] == DBNull.Value ? 0 : int.Parse(reader["NBRANCH"].ToString());
            ...
            {
                LogControl.save("ListarCabeceraInterfacesPoliza", ex.ToString(), "3");
                throw;
            }
            return Task.FromResult<InterfaceMonitoringPolizaVM>(entities);
        }
        ...
        // DETALLE DE PLANILLA MASIVOS
        public Task<InterfaceMonitoringPlanillaMasivosVM> ListarDetalleErroresPlanillaMasivos(InterfaceMonitoringPlanillaMasivosFilter data)
        {
            var parameters = new List<OracleParameter>();
            InterfaceMonitoringPlanillaMasivosVM entities = new InterfaceMonitoringPlanillaMasivosVM();
            entities.lista = new List<InterfaceMonitoringPlanillaMasivosVM.P_TABLE>();
            var procedure = string.Format("{0}.{1}", this.Package, "SPS_OI_SEL_PROCESS_MAS_ERR");
            try
            {
                parameters.Add(new OracleParameter("P_JOB", OracleDbType.Long, data.JOB, ParameterDirection.Input));
                parameters.Add(new OracleParameter("P_PROCESS", OracleDbType.Long, data.NIDPROCESS, ParameterDirection.Input));
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        InterfaceMonitoringPlanillaMasivosVM.P_TABLE suggest = new InterfaceMonitoringPlanillaMasivosVM.P_TABLE();
            ...
            {
                LogControl.save("ListarDetalleErroresPlanillaMasivos", ex.ToString(), "3");
                throw;
            }
            return Task.FromResult<InterfaceMonitoringPlanillaMasivosVM>(entities);
        }
            ...
            try
            {
                using (OracleConnection cn = new OracleConnection(ConfigurationManager.ConnectionStrings["cnxStringOracleOnlineDB"].ToString()))
                {
                    using (OracleCommand cmd = new OracleCommand())
                    {
                        ...
                        dataRpteXLS.P_NNUMORI = data.NNUMORI;
