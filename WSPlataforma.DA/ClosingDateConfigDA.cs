...
namespace WSPlataforma.DA
{
    ...
    public class ClosingDateConfigDA : ConnectionBase
    {
        ...
        public Task<RespuestaVM> AgregarConfiguracion(ClosingDateConfigFilterCrud data)
        {
            ...
            try
            {
                //string fechaInicio = data.DFECINI.ToString("dd/MM/yyyy");
                //string fechaFin    = data.DFECFIN.ToString("dd/MM/yyyy");
                //string fechaCierre = data.DFECCIERRE.ToString("dd/MM/yyyy");
                ...
                //parameters.Add(new OracleParameter("P_SFECINI",    OracleDbType.NVarchar2,      fechaInicio, ParameterDirection.Input)); // FECHA DE INICIO
                //parameters.Add(new OracleParameter("P_SFECFIN",    OracleDbType.NVarchar2,      fechaFin,    ParameterDirection.Input)); // FECHA DE FIN
                //parameters.Add(new OracleParameter("P_SFECCIERRE", OracleDbType.NVarchar2,      fechaCierre, ParameterDirection.Input)); // FECHA DE CIERRE
