...
{
    public class InmobiliaryReprocessDA : ConnectionBase
    {
            ...
            try
            {
                ...
                if (NIDPROCESS != 0)
                {
                    ...
                    (
                        ...
                        {
                            StartInfo = new ProcessStartInfo { FileName = ELog.obtainConfig("exePathRepro_INMO"), Arguments = arguments }
                        }
                    )
                    {
                        process.Start();
        ...
        void InsertLogerror(int P_NIDPROCESS, string P_SPROCEDURE, string P_SDESCRIPT)
        {
