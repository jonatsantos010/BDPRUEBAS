...
{
    public class ReporteCierreDA : ConnectionBase
    {
        ...
        public List<ReporteCierreVM> GetBranch()
        {
            ...
            var suggests = new List<ReporteCierreVM>();
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        var suggest = new ReporteCierreVM();
        ...
        public int InsertReportStatus(ReporteCierreFilter data)
        {
            try
            {
                ResponseControl generic = new ResponseControl(Response.Ok);

                var invoices = new List<ReporteCierreBM>();
                var parameters = new List<OracleParameter>();
        ...
        {
            var validations = new List<ReporteCierreBM>();
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        var validation = new ReporteCierreBM();
