...
{
    [RoutePrefix("Api/InmoInterfaceMonitoringCBCO")]
    [EnableCors(origins: "*", headers: "*", methods: "*")]
    public class InmobiliaryInterfaceMonitoringCBCO_Controller : ApiController
    {
        InmobiliaryInterfaceMonitoringCBCO_CORE InterfaceMonitoringCBCO_CORE = new InmobiliaryInterfaceMonitoringCBCO_CORE();
