...
namespace WSPlataforma.Controllers {
    ...
    [RoutePrefix("Api/InmoClosingDateConfig")]
    [EnableCors(origins: "*", headers: "*", methods: "*")]

    public class InmobiliaryClosingDateConfigController : ApiController {

        #region Filters
        InmobiliaryClosingDateConfigCORE ClosingDateConfigCORE = new InmobiliaryClosingDateConfigCORE();
