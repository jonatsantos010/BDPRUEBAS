...
{
    [RoutePrefix("Api/InterfaceMonitoring")]
    [EnableCors(origins: "*", headers: "*", methods: "*")]

    public class InterfaceMonitoringController : ApiController
    {
        InterfaceMonitoringCORE InterfaceMonitoringCORE = new InterfaceMonitoringCORE();
        ...
        {
            var result = this.InterfaceMonitoringCORE.ListarEstados();
            return Ok(result);
        }
        ...
        [Route("ListarCabeceraInterfacesSiniestros")]
        [HttpPost]
        public IHttpActionResult ListarCabeceraInterfacesSiniestros(InterfaceMonitoringSiniestrosFilter data)
        {
            var result = this.InterfaceMonitoringCORE.ListarCabeceraInterfacesSiniestros(data);
            return Ok(result);
        }
        [Route("ListarCabeceraInterfacesPoliza")]
        [HttpPost]
        public IHttpActionResult ListarCabeceraInterfacesPoliza(InterfaceMonitoringPolizaFilter data)
        {
            var result = this.InterfaceMonitoringCORE.ListarCabeceraInterfacesPoliza(data);
            return Ok(result);
        }
        ...
        // DETALLE PLANILLA
        [Route("ListarDetalleErroresPlanillaMasivos")]
        [HttpPost]
        public IHttpActionResult ListarDetalleErroresPlanillaMasivos(InterfaceMonitoringPlanillaMasivosFilter data)
        {
            var result = this.InterfaceMonitoringCORE.ListarDetalleErroresPlanillaMasivos(data);
            return Ok(result);
        }
